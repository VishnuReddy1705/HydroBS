...
import { ShieldCheck, Search, User, ArrowLeft, ArrowRight, RefreshCw } from 'lucide-react';
import api from '@/api';
...
export default function AuditLogViewer() {
  ...
  }, [page, pageSize, appliedSearch, actionType]);
      ...
      <form onSubmit={handleSearchSubmit} className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <select
            ...
            className="bg-white border border-slate-100 rounded-xl px-3 py-2 text-[11px] text-slate-700 font-bold focus:outline-none focus:border-[#00B4D8]"
          >
            <option value="">All Actions</option>
            <option value="LOGIN">Login Events</option>
            <option value="SUPER_ADMIN">Super Admin Actions</option>
            <option value="SETTINGS">Settings Changes</option>
            <option value="BILL">Billing Operations</option>
            <option value="METER">Meter Operations</option>
