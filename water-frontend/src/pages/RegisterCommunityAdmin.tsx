...
export default function RegisterAdmin() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-700 via-blue-500 to-cyan-400 flex items-center justify-center px-4">
      <motion.div 
      ...
      >
        <div className="flex flex-col items-center mb-6 text-center">
          ...
          <h1 className="text-2xl font-semibold text-white tracking-tight">Setup Community</h1>
          <p className="text-xs text-white/70 mt-1">Create your admin account</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="communityName" className="text-white/90">Community Name</Label>
            <Input id="communityName" placeholder="Greenwood Heights" 
          ...
          <div className="space-y-1.5">
            <Label htmlFor="fullName" className="text-white/90">Admin Full Name</Label>
        ...
        <p className="text-center text-xs text-white/70 mt-5">
          Already registered? <Link to="/login" className="underline hover:text-white">Log in</Link>
        </p>
      </motion.div>
    </div>
  )
